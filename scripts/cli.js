...
const contractABI = require("../artifacts/contracts/Alchemynode.sol/Alchemynode.json").abi;

program
    .name("alchemynode-cli")
    .description("CLI tool for Alchemynode smart contract")
    .version("1.0.0");
