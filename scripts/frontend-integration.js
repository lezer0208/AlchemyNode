 ...
 * This file demonstrates how to integrate Alchemynode with a web frontend
 */

// For React/Vue/Angular applications
export class AlchemynodeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new AlchemynodeClient(provider, contractAddress);
